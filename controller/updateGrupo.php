...
?>
		...
		if(isset($_POST['submit'])){
			...
			$st=$_POST['grupo'];
			$query=$mysqli->query("update grupo set Descricao='$st' where idGrupo='$id'");
			if($query)
			{
				?>
		...
		?>
			...
			<form method="post">
				<div class="form-group">
					...
					<input type="text" class="form-control" id="grupo" name="grupo" value="<?php echo $row['Descricao']?>" requerid>
				</div>
